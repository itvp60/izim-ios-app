    ...
    try {
      ...
      Alert.alert(
        ...
        nfcError.code === 'TAG_LOCKED'
          ...
          : nfcError.code === 'LOCK_FAILED'
            ? 'Метка не приняла блокировку и осталась перезаписываемой. Ссылка на ней работает как прежде. Попробуйте ещё раз; если повторится — эта метка блокировку не поддерживает.'
